...
> **Context:** A *build signal* marks a point in time where software changed. User feedback signals are the human side of that equation — they mark points in time where *users reacted* to what changed. Together, they let WatchTower answer: "Did this deploy upset people?"
...
- [Atlassian — CSAT vs NPS vs CES](https://www.atlassian.com/blog/customer-service)
- [Nielsen Norman Group — Timing of UX Surveys](https://www.nngroup.com/articles/when-to-gather-feedback/)
- [Intercom — In-app Feedback Best Practices](https://www.intercom.com/blog/in-app-feedback/)
