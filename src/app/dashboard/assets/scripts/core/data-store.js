...
let EVENTS = [
  ...
  makeEvent({
    ...
    minsAgo: 4,
    pathname: "/checkout",
    meta: { rating: 2, message: "Checkout button felt unresponsive." },
  }),
  makeEvent({
    project_id: 1,
    deployment_id: "dep_7e1b",
    ...
    minsAgo: 18,
    pathname: "/",
    meta: { rating: 5, message: "Fast and easy, thanks!" },
  }),
  makeEvent({
    project_id: 1,
    deployment_id: "dep_7e1b",
    ...
    minsAgo: 40,
    pathname: "/checkout",
    meta: { rating: 1, message: "Crashed when I tried to pay." },
  }),
  makeEvent({
    project_id: 1,
    deployment_id: "dep_6c0a",
...
export const dataStore = {
  ...
  async createProject(name, website_url) {
    const { error } = await postToServer("/api/projects/create", {
      name,
      website_url,
    });
    if (error) {
  ...
  async updateNotifyMethods(methods) {
    ...
    if (error) {
      console.log("Notification methods update failed:", error);
      return error;
    }
