...
// Claude/Gemini-style sidebar panel toggle icon:
// a rounded rect split by a left-rail divider line.
...
export class AppSidebar extends HTMLElement {
  ...
  render() {
    ...
    nav.querySelector("#sidebar-collapse-btn")?.addEventListener("click", (e) => {
      e.stopPropagation();
